...
class ReCaptcha {
    ...
    public function render() {
        $return = '<div  style="-moz-transform:scale(0.90); -ms-transform:scale(0.90); -o-transform:scale(0.90) ; -moz-transform-origin:0; -ms-transform-origin:0; -o-transform-origin:0; -webkit-transform:scale(0.90); transform:scale(0.90); -webkit-transform-origin:0 0; transform-origin:0; filter: progid:DXImageTransform.Microsoft.Matrix(M11=0.77,M12=0,M21=0,M22=0.77,SizingMethod="auto expand");" class="g-recaptcha" data-sitekey="' . $this->_sitekey . '"></div><input type="hidden" class="hiddenRecaptcha required" name="hiddenRecaptcha" id="hiddenRecaptcha">
